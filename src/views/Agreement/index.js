...
export default class ProductManual extends React.Component {
  ...
  render() {
    ...
    const { title, backPath } = this.props.route
    return (
      <div>
        {
          !App.isHighVersion &&
        ...
        <section className='protocol-text'>
          ...
          <div className='protocol-content'>
            为使用平台委托的第三方机构提供的银行卡核验和代扣付服务（以下简称“本服务”），您了解并同意：
          </div>
          <div className='protocol-content'>
          ...
          <div className='protocol-content'>
            四、本服务涉及银行、第三方支付机构等机构的合作。受银行、第三方支付机构等仅在工作日进行资金代扣及划转的现状等各种原因所限，本平台不对资金到账时间做任何承诺，也不承担与此相关的责任，包括但不限于由此产生的利息、货币贬值等损失；
          </div>
          <div className='protocol-content'>
